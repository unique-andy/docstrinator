...
setup(
  name = 'docstrinator',         # How you named your package folder (MyLib)
  packages = ['docstrinator'],   # Chose the same as "name"
  version = '0.01',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Decorator to generate docstrings for functions',   # Give a short description about your library
  author = 'Andrey',                   # Type in your name
